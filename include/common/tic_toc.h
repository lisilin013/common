...
#define FUNC_TIME_BEGIN long_term_slam::common::TicToc __func_tictoc;
#define FUNC_TIME_END                                                          \
  LOG(INFO) << __FUNCTION__ << " cost time: " << __func_tictoc.toc() << " ms.";
...
#define SEGMENT_TIME_BEGIN(segname) long_term_slam::common::TicToc segname;
